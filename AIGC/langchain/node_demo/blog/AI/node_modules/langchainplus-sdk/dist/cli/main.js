...
class PlusCommand {
    ...
    async startLocal() {
        ...
        console.info("LangChainPlus server is running at http://localhost:1984.  To connect locally, set the following environment variable when running your LangChain application.");
    ...
    async startAndExpose(ngrokAuthToken) {
        ...
        console.info("LangChainPlus server is running at http://localhost:1984. To connect remotely, set the following environment variable when running your LangChain application.");
        console.info("\tLANGCHAIN_TRACING_V2=true");
